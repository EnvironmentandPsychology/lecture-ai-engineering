...
# ============================================
st.divider()
st.subheader("このデモの使い方終了済み")
st.markdown("""
1. 完了：コードエディタでコメントアウトされた部分を見つけます（#で始まる行）
2. 完了：確認したい機能のコメントを解除します（先頭の#を削除）
3. 完了：変更を保存して、ブラウザで結果を確認します
4. 完了：様々な組み合わせを試して、UIがどのように変化するか確認しましょう
""")
